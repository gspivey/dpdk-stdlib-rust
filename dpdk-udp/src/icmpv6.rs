...
//!
//! Handles ICMPv6 echo request/reply (ping6) for IPv6 network diagnostics.
//! Parallels the IPv4 ICMP echo reply in `icmp.rs`.
//!
...
/// ICMPv6 header size: type(1) + code(1) + checksum(2) + identifier(2) + sequence(2)
...
/// Handles ICMPv6 echo request/reply for IPv6 sockets.
///
