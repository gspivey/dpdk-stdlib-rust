...
- [ ] 1. Create JUnit XML helper library (`scripts/integration-tests/harness-common.sh`)
  - [ ] 1.1 Implement JUnit XML generation functions
  ...
  - [ ] 1.2 Write property tests for JUnit XML generation
...
- [ ] 2. Create ENI configuration helper (`scripts/integration-tests/configure-eni.sh`)
  - [ ] 2.1 Implement ENI bind/unbind/status wrapper
...
- [ ] 3. Create Tier 1 test harness (`scripts/integration-tests/tier1-dpdk-echo.sh`)
  - [ ] 3.1 Implement Tier 1 DPDK↔DPDK echo test script
...
- [ ] 4. Create Tier 3 test harness (`scripts/integration-tests/tier3-iperf-interop.sh`)
  - [ ] 4.1 Implement Tier 3 DPDK↔iperf3 interoperability test script
...
- [ ] 5. Checkpoint - Verify harness scripts
...
- [ ] 6. Update CDK stack (`deploy/cdk/lib/dpdk-test-stack.ts`)
  - [ ] 6.1 Add new CDK outputs and iperf3 installation
...
- [ ] 7. Create orchestrator script (`scripts/run-integration-tests.sh`)
  - [ ] 7.1 Implement CLI argument parsing and validation
  ...
  - [ ] 7.2 Implement infrastructure deployment and readiness check
  ...
  - [ ] 7.3 Implement tier execution with ENI configuration
  ...
  - [ ] 7.4 Implement result collection and summary
  ...
  - [ ] 7.5 Implement JSON summary generation
  ...
  - [ ] 7.6 Write property tests for summary aggregation and exit code logic
...
- [ ] 8. Checkpoint - Orchestrator validation
  - Ensure orchestrator script passes `bash -n` syntax check
  - Ensure CLI argument parsing handles all flag combinations correctly
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Create GitHub Actions CI workflow (`.github/workflows/integration-tests.yml`)
  - [ ] 9.1 Implement the integration test workflow
