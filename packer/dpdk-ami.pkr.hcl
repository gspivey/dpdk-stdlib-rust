...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo dnf install -y git pciutils iperf3 clang-devel amazon-ssm-agent psmisc",
      "sudo dnf install -y nmap-ncat || echo 'Warning: nmap-ncat not available, tier3 kernel-interop ncat tests will be skipped'",
