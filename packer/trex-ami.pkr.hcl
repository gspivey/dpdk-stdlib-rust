...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo curl -fL --retry 3 --retry-delay 10 \"https://trex-tgn.cisco.com/trex/release/$${TREX_VERSION}.tar.gz\" -o trex.tar.gz || sudo curl -fLk --retry 3 --retry-delay 10 \"https://trex-tgn.cisco.com/trex/release/$${TREX_VERSION}.tar.gz\" -o trex.tar.gz",
